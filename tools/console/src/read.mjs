 ...
 * whose work has landed: an untouched branch's HEAD is already an ancestor of `main` (it was cut
 * from `main`), the same shape a landed merge-commit branch ends up in once it lands, so ancestry
 * alone cannot tell the two apart. The root tree always reports `finished: false` — the root is
...
export const LIBRARY = [
  ...
  { group: 'Skills and commands', blurb: 'The procedures the party follows.', items: ['.claude/skills/factory-run/SKILL.md', '.claude/skills/quest/SKILL.md', '.claude/skills/create-map/SKILL.md', '.claude/skills/factory-retro/SKILL.md', '.claude/commands/factory-status.md', '.claude/commands/gate.md'] },
];
